...
`Jaxon DbAdmin` results from the fork and redesign of the [Adminer](https://www.adminer.org/) core features into several [Composer packages](https://github.com/lagdo/jaxon-dbadmin-mono), and the integration of the [Jaxon library](https://www.jaxon-php.org).
